    ...
    <div className="my-5 container">
      <div className="row">
        <div className="col col-sm-auto">
          <img width="300" className="bg-white rounded shadow d-block mx-auto mb-4" src="../public/logo.svg" />
          {/* For the image tag above to be functional, you must move the logo.svg file from the images/
              directory into the app/public/ directory */}
        </div>
        <div className="col">
